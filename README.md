# Olá, eu sou Juscelia de Souza 👋

### Software Engineer | Front-end & Data Visualization

Sou desenvolvedora focada em construir interfaces de alta performance que transformam dados complexos em decisões estratégicas. Com **Bacharelado em Sistemas de Informação** e **MBA em Desenvolvimento de Tecnologias Digitais**, busco o equilíbrio entre arquitetura sólida e experiência do usuário.

---

### 🛠️ No que estou focada agora:
- **Engenharia de Software:** Desenvolvimento escalável com **React**, **TypeScript** e **Next.js**.
- **Cultura de Dados:** Especialização em Visualização de Dados e Análise Exploratória com **Python (Pandas)** e **SQL**.
